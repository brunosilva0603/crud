                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('usuarios/add') }}" method="post" oninput='password2.setCustomValidity(password2.value != password.value ? "Passwords do not match." : "")'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="user_id" value="{{ $usuario->user_id }}" required autocomplete="name" autofocus>
                    ...
                    <form action="{{ url('usuarios/add') }}" method="post" oninput='password2.setCustomValidity(password2.value != password.value ? "Passwords do not match." : "")'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="user_id" value="{{ old('name') }}" required autocomplete="name" autofocus>
